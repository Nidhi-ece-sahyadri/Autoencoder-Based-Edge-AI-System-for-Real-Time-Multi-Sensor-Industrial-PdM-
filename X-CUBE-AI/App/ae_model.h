/**
  ...
  ******************************************************************************
  */
#ifndef AI_AE_MODEL_H
#define AI_AE_MODEL_H

#include "ae_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_AE_MODEL_MODEL_NAME          "ae_model"
#define AI_AE_MODEL_ORIGIN_MODEL_NAME   "ae_model"

/******************************************************************************/
#define AI_AE_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_AE_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_AE_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_AE_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_AE_MODEL_IN \
  ai_ae_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AE_MODEL_IN_SIZE { \
  AI_AE_MODEL_IN_1_SIZE, \
}
#define AI_AE_MODEL_IN_SIZE_BYTES { \
  AI_AE_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_AE_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_AE_MODEL_IN_1_CHANNEL     (14)
#define AI_AE_MODEL_IN_1_SIZE        (14)
#define AI_AE_MODEL_IN_1_SIZE_BYTES  (56)

/******************************************************************************/
#define AI_AE_MODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_AE_MODEL_OUT \
  ai_ae_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AE_MODEL_OUT_SIZE { \
  AI_AE_MODEL_OUT_1_SIZE, \
}
#define AI_AE_MODEL_OUT_SIZE_BYTES { \
  AI_AE_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_AE_MODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_AE_MODEL_OUT_1_CHANNEL     (14)
#define AI_AE_MODEL_OUT_1_SIZE        (14)
#define AI_AE_MODEL_OUT_1_SIZE_BYTES  (56)

/******************************************************************************/
#define AI_AE_MODEL_N_NODES (8)
 ...
 * @ref ai_ae_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_ae_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ae_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_ae_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_AE_MODEL_*
 * defines into file @ref ae_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
